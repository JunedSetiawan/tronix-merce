...
class AuthControllerTest extends TestCase
{
    ...
    {
        $response = $this->json('POST', route('api.password.email'), ['email' => 'invalid@email.com']);
    ...
    {
        $user = User::first();
        $response = $this->json('POST', route('api.password.email'), ['email' => $user->email]);
    ...
    public function test_reset_password_success()
    {
        ...
        $response = $this->json('POST', route('api.password.reset'), [
            'token' => $token,
            'email' => $user->email,
