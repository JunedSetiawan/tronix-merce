<x-guest-layout>
    ...
    <div class="relative">
        <img class="w-full object-cover brightness-50 filter lg:h-[500px]"
            src="{{ route('image.get', ['filename' => 'default-image.png']) }}" alt="Living room image" />
    ...
    <section class="mx-auto grid max-w-[1200px] grid-cols-2 px-5 lg:grid-cols-3 lg:gap-5">
        ...
        <a href="#">
            <div class="relative cursor-pointer">
                <img class="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
                    src="{{ route('image.get', ['filename' => 'default-image.png']) }}" alt="bedroom cathegory image" />
        ...
        <a href="#">
            <div class="relative cursor-pointer">
                <img class="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
                    src="{{ route('image.get', ['filename' => 'default-image.png']) }}" alt="Matrass cathegory image" />
        ...
        <a href="#">
            <div class="relative cursor-pointer">
                <img class="mx-auto h-auto w-auto brightness-50 duration-300 hover:brightness-100"
                    src="{{ route('image.get', ['filename' => 'default-image.png']) }}" alt="kitchen cathegory image" />
            ...
            <ul class="splide__list mx-auto max-w-[1200px]">
                ...
                <li class="splide__slide">
                    <div class="flex flex-col">
                        <img class="" src="{{ route('image.get', ['filename' => 'default-image.png']) }}"
                            alt="sofa image" />
    ...
    <div class="mx-auto max-w-[1200px] px-5">
        <section class="mt-10 flex max-w-[1200px] justify-between bg-violet-900 px-5">
            ...
            <img class="-mr-5 hidden w-[550px] object-cover md:block"
                src="{{ route('image.get', ['filename' => 'default-image.png']) }}"
